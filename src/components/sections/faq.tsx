...
const faqs = [
    ...
    {
        question: "場所はどこで行いますか？",
        answer: "仙台駅周辺のコワーキングスペースやカフェで行います。オンライン（Zoom）での対応も可能ですが、対面でのサポートを基本としています。",
    },
    {
    ...
    },
    {
        ...
        answer: "はい、可能です。最初はスタンダードコースで始めて、本格的に作り込みたい時期だけプライベートレッスンにするなど、状況に合わせて柔軟に対応いたします。",
    },
    {
